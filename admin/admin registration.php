                      ...
                      <tbody><tr>
                        <form name="form1" id="form1" method="post" onSubmit="return memloginvalidate()">
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                              ...
                              <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Firstname</font></td>
                                <td width="">:</td>
                                <td width="160">
								<input name="txtfirstname" class="forminput" id="txtfirstname" maxlength="20" type="text" placeholder="enter your first name" size="30" required></td>
                              </tr>
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Lastname</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtlastname" class="forminput" id="txtlastname" maxlength="20" type="text" placeholder="enter your last name" size="30" required></td>
                              </tr>
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">E-mail Id</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtemailid" class="forminput" id="txtemailid" maxlength="30" type="text" placeholder="enter your e-mail id" size="30" required></td>
                              </tr>
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Confirm E-mail Id</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtemailid" class="forminput" id="txtemailid" maxlength="20" type="text" placeholder="re-enter your e-mail id" size="30" required></td>
                              </tr>
							   <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Contact No.</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtnumber" class="forminput" id="txtcontact no." maxlength="20" type="number" placeholder="enter your contact no." size="30" required></td>
                              </tr>
							  <tr>
                                <td width="">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:12px;">Confirm Contact No.</font></td>
                                <td width="">:</td>
                                <td width="">
								<input name="txtnumber" class="forminput" id="txtcontact no." maxlength="20" type="number" placeholder="re-enter your contact no." size="30" required></td>
                              </tr>
                              <tr>
