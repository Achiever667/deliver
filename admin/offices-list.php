...
<table border="0" align="center" width="80%">
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      <td class="newtext" bgcolor="#EDEDED" width="15%">Office Name </td>
	  ...
	  <td class="newtext" bgcolor="#EDEDED" width="10%">Delete Office</td>
    </tr>
	<?php
	...
	?>
      <tr onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#FFFFFF" style="height:20px;">
        ...
        <td class="gentxt"><?php echo $row['off_name']; ?></td>
      <td class="gentxt"><?php echo $row['address']; ?></td>
      <td class="gentxt"><?php echo $row['city']; ?></td>
      <td class="gentxt"><?php echo $row['ph_no']; ?></td>
      <td class="gentxt"><?php echo $row['office_time']; ?></td>
	  <td class="gentxt"><?php echo $row['contact_person']; ?></td>
	  	   <td><a href="delete-office.php?id='<?php echo $row['id']; ?> ' ">delete </a></td>
    </tr>
    <?php
	}//while
	?>
