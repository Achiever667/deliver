        ...
        <td class="Partext1"><div align="center">
          <table cellpadding="4" cellspacing="0" align="center" width="70%">
            <form action="new_track_submit.php" method="post" name="form1" id="form1" onsubmit="return validate()"></form>
              <tbody><tr>
                <td colspan="2" class="TrackTitle" valign="top"><div class="newtext" align="center">
				<strong> <br> Enter Consignment Number &nbsp &nbsp <br> <br>
                              </strong></div></td>
              </tr>
              <tr>
			  ...
			  <form action="search-courier.php" method="post">
                <td valign="top"><div align="right" style="margin-top:5px;font-size:15px;">Enter Consignment number&nbsp &nbsp  </div></td>
