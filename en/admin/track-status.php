...
<link href="http://localhost/newshhipping/admin/css/form.css" rel="stylesheet" type="text/css">
<script>
...
<footer class="container-fluid" style="background-color:#892525; width:100%;">
     <div class="container">
         <div class="row footer1">
			...
			<img src="http://localhost/newshhipping/admin/images/master.png">
			<img src="http://localhost/newshhipping/admin/images/visa.png">
			<img src="http://localhost/newshhipping/admin/images/american-express.png">
			<img src="http://localhost/newshhipping/admin/images/discover.png">
			</div>
			</div>
